...
# Initialize a global variable for the reader, but don't load it yet
reader = None

def get_reader():
    """
    A helper function to lazily initialize the EasyOCR reader.
    It will only be created the first time it is called.
    """
    global reader
    if reader is None:
